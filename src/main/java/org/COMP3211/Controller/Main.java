package org.COMP3211.Controller;

import org.COMP3211.Model.Game;
import org.COMP3211.Model.Save;
import org.COMP3211.View.View;
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "2":
                    ...
                    if (!replayFile.isEmpty()) Replay.replayRecord(replayFile);
    ...
    public static void endGame(String winner){
        ...
        if (winner != null) {
            ...
            if (game.getGameRecord() != null) {
                ...
                Save.saveRecord(game.getGameRecord(), "game.record");
            }
        }
        game = null;
    }
        ...
        while (true) {
            ...
            switch (_command[0]) {
                ...
                case "record" -> {
                    ...
                    if (game.getGameRecord() != null) {
                        Save.saveRecord(game.getGameRecord(), filename);
                    } else {
                ...
                case "save" -> {
                    ...
                    if (game.getGameRecord() != null) {
                        Save.saveGame(game.getGameRecord(), filename);
                    } else {
